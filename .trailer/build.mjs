...
const FRAMES = [
  ...
  ['Lenses', frame({ beat: 'ii.', kicker: 'The Lenses', fragId: 'lenses',
    head: 'One map, read seven ways.',
    copy: 'Structure shows what rests on what. Tensions sets each conflict against the thing it pulls against. Evidence asks which claims are actually held up. Three more open when the work turns mathematical.' })],
  ...
  ['Calculus', frame({ beat: 'v.', kicker: 'At Any Level', fragId: 'calculus', inner: 840,
    head: 'The same board — algebra, calculus, statistics.',
  ...
  ['Guard', frame({ beat: 'vi.', kicker: 'The Answer Guard', fragId: 'guard', inner: 900, lift: 40,
    head: 'While you are learning mathematics, it will not hand you the answer.',
  ...
  ['Close', card({
    ...
    copy: 'Every map you build stays on screen, stays interactive, and stays yours — at every tier, always.',
    foot: 'socria.app',
  })],
];
